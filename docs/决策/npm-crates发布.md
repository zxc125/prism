...
| crates.io | `tauri-plugin-observer` | 0.2.2 | 外部 Tauri 应用 Rust 协调插件（P16 起 Local 泛化 + list/export 只读命令；P17 起 `append_events` async 化脱主线程，0.2.2 补 `export_session` async 化同类遗漏） |
