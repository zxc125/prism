<!--
  Source: DavidHDev/vue-bits (https://github.com/DavidHDev/vue-bits)
  Component: Backgrounds/Aurora
  License: MIT + Commons Clause License Condition v1.0
  Copyright (c) 2025 David Haz

  Fetched from the @vue-bits jsrepo registry. See site/THIRD_PARTY_NOTICES.md
  for full terms. Do not remove this header.
-->
<template>
